...
- Stripe: `STRIPE_SECRET_KEY`, `STRIPE_WEBHOOK_SECRET`, `STRIPE_PUBLISHABLE_KEY` (server), `VITE_STRIPE_PUBLISHABLE_KEY` (frontend). Never expose the secret keys to the client.
